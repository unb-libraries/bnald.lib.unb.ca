...
/**
 * Provides a form for reverting a Source Document revision for a single translation.
 *
 * @ingroup bnald_core
 */
class SourceDocumentRevisionRevertTranslationForm extends SourceDocumentRevisionRevertForm {
  ...
  /**
   * Constructs a new SourceDocumentRevisionRevertTranslationForm.
   *
  ...
  public function getFormId() {
    return 'source_document_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $source_document_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $source_document_revision);
