 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/structure/source_document/{source_document}",
 *     "add-form" = "/admin/structure/source_document/add",
 *     "edit-form" = "/admin/structure/source_document/{source_document}/edit",
 *     "delete-form" = "/admin/structure/source_document/{source_document}/delete",
 *     "version-history" = "/admin/structure/source_document/{source_document}/revisions",
 *     "revision" = "/admin/structure/source_document/{source_document}/revisions/{source_document_revision}/view",
 *     "revision_revert" = "/admin/structure/source_document/{source_document}/revisions/{source_document_revision}/revert",
 *     "revision_delete" = "/admin/structure/source_document/{source_document}/revisions/{source_document_revision}/delete",
 *     "collection" = "/admin/structure/source_document",
 *   },
...
class SourceDocument extends RevisionableContentEntityBase implements SourceDocumentInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['status'] = BaseFieldDefinition::create('boolean')
      ...
      ->setDescription(t('A boolean indicating whether the Source Document is published.'))
      ->setRevisionable(TRUE)
